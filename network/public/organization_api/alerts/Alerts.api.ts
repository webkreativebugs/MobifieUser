...
export async function fetchAlerts(
  ...
  const url = API_ENDPOINTS.ALERTS(AlertmodifiedUrlConfig.search,AlertmodifiedUrlConfig.page,AlertmodifiedUrlConfig.limit,OrganizationDetailsConfig.orgName);
  try {
