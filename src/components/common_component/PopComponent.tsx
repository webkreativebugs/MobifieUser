...
const PopComponent: React.FC<PopComponentProps> = ({
  setIsPop,
  orgName,
  setOrgName,
  orgDetails,
    ...
    >
      ...
      >
        <div className="flex justify-between mt-2">
          ...
          <button className="mt-[-40px] mr-[-16px]" onClick={handleClose}>
            <svg
              width="30"
              height="30"
              viewBox="0 0 24 24"
        ...
        <div className="flex justify-end mt-6">
          ...
          <button
            ...
            className={`mr-4 border rounded-lg px-6 py-1 text-white ${
