...
function DisplayBillingDetails() {
  ...
  return (
    <div className=" flex justify-center items-center flex-col">
      ...
      {/* Invoice Card */}
      <div className="card-bg p-8 w-2/3 mt-24 rounded-2xl shadow-2xl border border-gray-200">
        {/* Page Header */}
        <div className="flex justify-between items-center border-b pb-4 mb-6">
          <div>
            <h1 className="text-4xl font-extrabold text-[#7ed957]">INVOICE</h1>
          ...
          <div className="text-right">
            <p className="text-sm font-semibold text-gray-700">
              Invoice #<span className="text-[#7ed957]">{invoice.id}</span>
            </p>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {items.map((item, idx) => (
                ...
                >
                  <td className="p-4 border-r border-gray-200">{item.name}</td>
      ...
      <div className="flex justify-end w-2/3  gap-4 mt-6 print:hidden ">
        <button
          onClick={handlePrint}
