...
const AppConfigMask = ({
  ...
  const ChildComponent = (disable: boolean) => {
    if (selectedScreen === DefaultVAlues.API)
      return <ApiConfig disable={disable} />;
    if (selectedScreen === DefaultVAlues.CLIENT)
      return <ClientConfig disable={disable} />;
    if (selectedScreen === DefaultVAlues.DEFAULT)
      return <DefaultConfig disable={disable} />;
    if (selectedScreen === DefaultVAlues.WEB)
      return <WebUrlConfig disable={disable} />;
    if (selectedScreen === DefaultVAlues.YOU)
      return <YouConfig disable={disable} />;
  };
