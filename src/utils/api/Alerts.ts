...
import {AlertResponse,AlertCallback,AlertUrlConfig  } from "../../../network/public/organization_api/alerts/Alerts.interface";
// import { Dispatch, SetStateAction } from "react";
// import { customAuthorizationConfig } from "../../../network/FetchRequest";
function fetchAllAlerts(setApiResponse:any,setApiError:any, setLoader:any ){
