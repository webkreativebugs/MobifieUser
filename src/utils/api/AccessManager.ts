...
import { MemberResponse,
  MemberCallback  } from "../../../network/public/accessManager_api/accessManager.interface";
// import { Dispatch, SetStateAction } from "react";
// import { customAuthorizationConfig } from "../../../network/FetchRequest";
function getAccessManagerData(setApiResponse:any,setApiError:any, setLoader: (loading: boolean) => void){
